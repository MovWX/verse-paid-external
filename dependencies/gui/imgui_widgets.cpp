...
bool ImGui::TabButtonEx(const char* ico, const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    if (tab_count == 0 && label == "AimAssist") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

    if (tab_count == 1 && label == "Visuals") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

    if (tab_count == 2 && label == "Exploits") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

    if (tab_count == 3 && label == "Misc") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

    if (tab_count == 4 && label == "Customization") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));
...
bool ImGui::OptButtonEx(const char* ico, const ImVec2& size_arg, bool rotation, ImGuiButtonFlags flags)
{
    ...
    ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(accent_color[0], accent_color[1], accent_color[2], it_nameanim->second));
    RenderTextClipped(bb.Min + style.FramePadding, bb.Max - style.FramePadding, ico, NULL, &label_size, style.ButtonTextAlign, &bb);
    ImGui::PopStyleColor();
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    window->DrawList->AddRectFilled(check_bb.Min + ImVec2(4 + distance, 8), check_bb.Max + ImVec2(9 + distance, -9), ImColor(0.10f, 0.10f, 0.10f, 1.00f - it_nameanim->second), 10);

    window->DrawList->AddRectFilled(check_bb.Min + ImVec2(5 + distance, 8), check_bb.Max + ImVec2(it_nameanim->second * 11 + distance - 7, -8), ImColor(1.f, 1.f, 1.f, 1.f), 10);

    window->DrawList->AddCircleFilled(ImVec2(check_bb.Min.x + distance + 13 + it_nameanim->second * 15, check_bb.Min.y + 10), 7.f, ImColor(34 / 255.f, 37 / 255.f, 43 / 255.f, 1.00f), 24);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    const ImRect total_bb(bb.Min, bb.Max + ImVec2(label_size.x > 0.0f ? style.ItemInnerSpacing.x + label_size.x : 0.0f, 0.0f)- ImVec2(50, 0));
    ItemSize(total_bb, style.FramePadding.y);
    ...
    ImRotateStart();
    RenderTextClipped(bb.Min + style.FramePadding + ImVec2(110, 1), ImVec2(value_x2 + 50, bb.Max.y), " ", NULL, NULL);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    const float size = GetWindowWidth() - 20.f;
    ...
    const ImRect frame_bb(window->DC.CursorPos, window->DC.CursorPos + ImVec2(120, label_size.y + style.FramePadding.y * 2.0f));
    ...
    window->DrawList->AddRectFilled(clickable.Min + ImVec2(0.f, 7.f), grab_bb.Max - ImVec2(10.f, 5.f), ImColor(205, 205, 205, 255));
    window->DrawList->AddCircleFilled(grab_bb.Min + ImVec2(5.f, 6.f), 6.f, ImColor(235, 235, 235, 255), 30.f);
    window->DrawList->AddText(rect.Min, ImColor(130, 131, 134), label);

    PushStyleColor(ImGuiCol_Text, ImVec4(ImColor(130, 131, 134)));
    RenderTextClipped(rect.Min, rect.Max, value_buf, value_buf_end, NULL, ImVec2(1.f, 0.f));
    PopStyleColor();
        ...
        if (render_selection)
        {
            ...
            for (const ImWchar* p = text_selected_begin; p < text_selected_end; )
            {
                ...
                else
                {
                    ...
                    if (rect.Overlaps(clip_rect)) draw_window->DrawList->AddRectFilled(rect.Min + ImVec2(-2, +1.8f), rect.Max + ImVec2(3, -3), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.30f), 5);
                }
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    if (hovered || selected)
    {
        ...
        PushStyleColor(ImGuiCol_Text, ImVec4(accent_color[0], accent_color[1], accent_color[2], 1.00f));
