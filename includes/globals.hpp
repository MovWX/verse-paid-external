...
public:
	...
	float boxvisible[4] = { 255.f, 0.f, 0.f, 1.f };
	float skelevisible[4] = { 255.f, 0.f, 0.f, 1.f };

	float skel_thickness = 1;

	float nonvisiblebox[4] = { 255.f, 0.f, 255.f, 1.f };
	float nonvisibleskele[4] = { 255.f, 0.f, 255.f, 1.f };
